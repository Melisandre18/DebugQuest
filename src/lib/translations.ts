  ...
  ka: {
    ...
    game: {
      ...
      conceptExplainers: {
        ...
        "off-by-one":       "ციკლის საზღვრები ენის მიხედვით ინკლუზიური ან ექსკლუზიურია. ყოველთვის გაიარე პირველი და ბოლო იტერაცია.",
        ...
        "infinite-loop":    "while-ციკლი მხოლოდ მაშინ სრულდება, როდესაც ციკლის ცვლადი ყოველ იტერაციაზე პირობის false-ად გახდისკენ მიდის.",
        "wrong-init":       "ა კუმულატორის (ჯამი, მაქსიმუმი, მინიმუმი, დათვლა) საწყისი მნიშვნელობა განსაზღვრავს, რას ითვლის ციკლი.",
