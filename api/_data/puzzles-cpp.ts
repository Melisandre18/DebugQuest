...
const cpp2: TextPickFixDef = {
  ...
  story: { en: "A loop that sums an array reads one element past the end, causing undefined behavior.", ka: "მასივის შემჯამებელი ციკლი ბოლოს გადასცდება და გაუმართავ ქცევას იწვევს." },
  ...
  hints: [
    ...
    { en: "The last valid index is size - 1. Your loop goes one step further.", ka: "ბოლო სწორი ინდექსია size - 1. შენი ციკლი ერთი ნაბიჯით გადასდის." },
  ...
  fixes: [
    {
      ...
      explanation: { en: "i < size stops the loop at index size-1, the last valid position.", ka: "i < size ციკლს size-1 ინდექსზე ჩერებს, რაც ბოლო სწორი პოზიციაა." },
    },
    {
