...
const js2: TextPickFixDef = {
  ...
  bugType: "scope-error",
  programmingLanguage: "javascript",
  concept: { en: "var is function-scoped; closures inside a loop all share the same var binding", ka: "var ფუნქციის სფეროსაა; ციკლში დახურვები ერთ var ბმას იზიარებს" },
  ...
  task: { en: "Fix the loop so each callback captures its own index.", ka: "გაასწორე ციკლი, რომ თითოეულმა callback-მა საკუთარი ინდექსი დაიჭიროს." },
  hints: [
...
fns[2]();  // 2`,
  ...
  fixes: [
    ...
    },
    {
      ...
      explanation: { en: "const cannot be reassigned — the i++ in the loop header would throw a TypeError.", ka: "const-ი ვერ გადაინიჭება — i++ ციკლის სათაურში TypeError-ს გამოიძახებს." },
    },
  ],
};
...
const js7: TextPickFixDef = {
  ...
  programmingLanguage: "javascript",
  concept: { en: "return inside forEach only exits the callback, not the loop; use for...of to break early", ka: "return forEach-ში მხოლოდ callback-დან გამოდის, არა ციკლიდან; for...of გამოიყენე ადრე გასასვლელად" },
  title: { en: "The Unstoppable Loop", ka: "გაუჩერებელი ციკლი" },
  ...
  task: { en: "Rewrite the loop so it actually stops as soon as the target is found.", ka: "ციკლი გადაწერე ისე, რომ სამიზნის პოვნასთანავე ნამდვილად შეჩერდეს." },
  hints: [
    { en: "Does forEach have a way to break? Check MDN.", ka: "forEach-ს გაჩერების საშუალება აქვს? MDN შეამოწმე." },
    { en: "return inside forEach just finishes that single callback invocation — the loop continues.", ka: "return forEach-ში მხოლოდ ამ ერთ callback-ის გამოძახებას ასრულებს — ციკლი გრძელდება." },
    { en: "Replace forEach with a for...of loop and use break.", ka: "forEach for...of ციკლით შეცვალე და break გამოიყენე." },
  ],
  format: "text",
  interaction: "pick-fix",
  ...
  fixes: [
    {
      ...
      explanation: { en: "for...of supports break, so the loop genuinely stops at the first match.", ka: "for...of break-ს მხარს უჭერს, ამიტომ ციკლი პირველ დამთხვევაზე ნამდვილად ჩერდება." },
    },
    {
      id: "array-find", correct: false,
      label: { en: "Use arr.find(item => item === target)", ka: "arr.find(item => item === target) გამოიყენე" },
      explanation: { en: "find is correct and idiomatic, but the task asks to fix the loop structure, not replace it entirely.", ka: "find სწორი და სტანდარტულია, მაგრამ ამოცანა ციკლის სტრუქტურის გასწორებაა, არა მის სრულ შეცვლა." },
    },
    {
      ...
      explanation: { en: "Throwing to break a loop is an anti-pattern — hard to read and error-prone.", ka: "ციკლის გასათიშად გამოსროლა ანტი-შაბლონია — წასაკითხად ძნელია და შეცდომებისადმი მიდრეკილია." },
    },
  ],
};
